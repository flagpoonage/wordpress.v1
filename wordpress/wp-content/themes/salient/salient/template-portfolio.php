					...
					<div class="col <?php echo $span_num . ' '. $masonry_item_sizing; ?> element <?php echo $project_cats; ?>" data-project-cat="<?php echo $project_cats; ?>" <?php if(!empty($project_accent_color)) { echo 'data-project-color="' . $project_accent_color .'"'; } else { echo 'data-default-color="true"';} ?>>
						...
						<?php //project style 1
							...
							<div class="work-meta">
								...
								<?php 
									 if(!empty($project_excerpt)) { echo $project_excerpt; } elseif(!empty($options['portfolio_date']) && $options['portfolio_date'] == 1) echo get_the_date();
								?>
						...
						//project style 2
							...
							<div class="work-item style-2">
								...
								<div class="work-info">
									...
									<div class="vert-center"><h3><?php echo get_the_title(); ?></h3> <p><?php if(!empty($project_excerpt)) { echo $project_excerpt; } elseif(!empty($options['portfolio_date']) && $options['portfolio_date'] == 1) echo get_the_date(); ?></p></div><!--/vert-center-->
