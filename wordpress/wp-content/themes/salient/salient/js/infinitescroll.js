...
(function (window, $, undefined) {
    ...
    $.infinitescroll.prototype = {
        ...
        _create: function infscr_create(options, callback) {
            ...
            // Define loading.msg
            opts.loading.msg = opts.loading.msg || $('<div class="infscr-loading-wrap"><div id="infscr-loading"><img alt="Loading..." src="' + opts.loading.img + '" /><div>' + opts.loading.msgText + '</div></div></div>');
