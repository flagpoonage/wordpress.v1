...
function nectar_colors() {
	...
	#header-outer .widget_shopping_cart a.button, #header-outer a.cart-contents span, .swiper-slide .button.solid_color a, #portfolio-filters, button[type=submit]:hover, #buddypress button:hover, #buddypress a.button:hover, #buddypress ul.button-nav li.current a, #buddypress a.button:focus '.$woocommerce_main.'
	{
	...
	if(!empty($options["extra-color-1"])) { 
		...
		.nectar-button.regular-button.extra-color-1 { background-color: '.$options["extra-color-1"].'!important; }
	...
	if(!empty($options["extra-color-2"])) { 
		...
		.nectar-button.regular-button.extra-color-2 { background-color: '.$options["extra-color-2"].'!important; }
	...
	if(!empty($options["extra-color-3"])) { 
		...
		.nectar-button.regular-button.extra-color-3 { background-color: '.$options["extra-color-3"].'!important; }
