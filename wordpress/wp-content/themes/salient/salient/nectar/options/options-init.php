	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                ...
                'type' => 'select', 
                'title' => __('Nectar/Home Slider Caption & Testimonial', NECTAR_THEME_NAME),
                'desc' => '',
                'options' => $typography_mixed_fonts
			),
	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                ...
                'type' => 'color',
                'title' => 'Header Starting Text Color', 
        ...
        'fields' => array(
			...
			array(
			 ...
			 array(
                ...
                'sub_desc' => 'By default, your copyright section will say "© {YEAR} {SITENAME}" before the additional text you add above in the Footer Copyright Section Text input - This option allows you to remove that.',
                'desc' => ''
            ),
	...
	$sections[] = array(
        ...
        'fields' => array( 	
			...
			array(
                ...
                'sub_desc' => 'Use this to define a main color that will be used in combination with the greyscale option for your map',
                'desc' => '',
                'std' => ''
            )
