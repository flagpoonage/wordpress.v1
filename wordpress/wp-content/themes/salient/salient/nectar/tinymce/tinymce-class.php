...
$nectar_shortcodes['button'] = array( 
	...
	'attr'=>array(
		...
		'color'=>array(
			...
			'values' => array(
			     "accent-color" => "Regular + Accent-Color",
		  		 "extra-color-1" => "Regular + Extra-Color-1",
		  		 "extra-color-2" => "Regular + Extra-Color-2",
		  		 "extra-color-3" => "Regular + Extra-Color-3",
		  		 "see-through" => "See-Through",
		  		 "see-through-2" => "See-Through + Solid On Hover"
			)
		),
...
$nectar_shortcodes['nectar_portfolio'] = array( 
	...
	'attr'=>array( 
		...
		'constrain_max_cols'=>array(
			...
			'desc' => __("This will change the max columns to 4 (default is 5 for fullwidth). Activating this will make it easier to create a grid with no empty spaces at the end of the list on all screen sizes. (Won't be used if masonry layout is active)", NECTAR_THEME_NAME)
		),
		'category' => array(
			'type' => 'multi-select',
		...
		'project_style' => array(
			...
			'values' => array(
			   ...
			   '3' => 'Title overlaid w/ zoom effect on hover',
			   '4' => 'Meta from bottom on hover + entire thumb link'
			)
		),
