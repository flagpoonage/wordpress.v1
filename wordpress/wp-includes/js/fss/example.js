(function(){
  ...
  var controls = document.getElementById('fss-controls');
  var output = document.getElementById('fss-output');
  var ui = document.getElementById('fss-ui');
  ...
  function setRenderer(index) {
    ...
    switch(index) {
      ...
      case CANVAS:
        ...
        renderer.element.setAttribute('id', 'backgroundCanvas');
        break;
      case SVG:
  ...
  function getSizing(){
	var w = window,
  	...
  	var el = document.getElementById('fss-spacer');
